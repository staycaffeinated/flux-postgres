...
import com.fvogel.broadcom.stereotype.*;
import com.fvogel.broadcom.validation.*;
import javax.validation.constraints.NotEmpty;
import javax.validation.constraints.NotNull;
import javax.validation.constraints.Null;

/**
 * This is the POJO of User data exposed to client applications
 */
@lombok.Data
...
@JsonDeserialize(builder = User.DefaultBuilder.class)
@Builder(builderClassName = "DefaultBuilder", toBuilder = true)
public class User implements RestfulResource<String> {
